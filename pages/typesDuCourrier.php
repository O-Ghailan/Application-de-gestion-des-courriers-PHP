...
<body>
    ...
    <div style="text-align:center">
        <div class="container">
            <div class="card">
                <h4 class="card-header"><b>Types</b></h4>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT reference, designation FROM typeCourrier";
                            ...
                            <a href="typesDuCourrier.php"  data-toggle="modal" data-target="#myModal">Ajouter un type du courrier</a>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Ajouter un type du courrier</h4>
