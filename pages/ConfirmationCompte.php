...
<body>
    <nav class="navbar navbar-dark navbar-expand-sm fixed-top">
        <div class="container">
            ...
            <div class="menu-bar">
                <ul>
                    <li><a href="menuPrincipal.php"> Référentiel</a>
                        <div class="sub-menu-1">
                            <ul>
                                ...
                                <li><a href="typesDuCourrier.html">Types du courrier</a></li>
                                <li><a href="supportsDuCourrier.html">Supports du courrier</a></li>
                                <li><a href="instructions.html">Instructions</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="active"><a href='ajouterUtilisateur.html'> Ajouter un utilisateur</li>
    ...
    <div style="text-align:center">
        <br>
        <img src="logo.jpg" alt="Avatar" style="width:8%" class="center">
        <div class="container">
        ...
        <div class="container">
            <div class="card bg-light text-black">
              <div class="card-body"><h5 center><i class="fa fa-check" aria-hidden="true"></i>
                La création du compte est achevée avec succès!</h5></div>
              
              <p><a href="Utilisateurs.php"><button class="btn btn-success">Afficher les utilisateurs</button></a></p>
