...
<body>
    ...
    <div style="text-align:center">
        <div class="container">
            <div class="card">
                <h4 class="card-header"><b>Entités de destination</b></h4>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <?php
                                ...
                                $sql = "SELECT entite, entiteDes, reference FROM entitesdestination";
                                $result = $conn->query($sql);
                                if ($result->num_rows > 0) {
                                // output data of each row
                                while($row = $result->fetch_assoc()) {
                                echo "<tr><td>" .$row["entite"]. "</td><td>" .$row["entiteDes"]. "</td><td><input type ='checkbox' name='checkbox[]' value='".$row["reference"]."'></td></tr>";
                            ...
                            <a href="entitéDeDestination.php"  data-toggle="modal" data-target="#myModal">Ajouter une entité de destination</a>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Ajouter une entité de destination</h4>
                                            ...
                                            <form action="destination.php" method="POST">
                                                <div class="form-group row">
                                                    <div class="form-group col-md-6">
                                                        <label class="sr-only" for="entite">Entité</label>
                                                        <input type="text" class="form-control form-control-sm mr-1" name="entite" id="entite" placeholder="Entité" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="sr-only" for="entiteDes">Entité de destination</label>
                                                        <input type="text" class="form-control form-control-sm mr-1" name="entiteDes" id="entiteDes" placeholder="Entité de destination" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
