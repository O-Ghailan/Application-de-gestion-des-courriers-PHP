...
<body>
    ...
    <div style="text-align:center">
        <div class="container">
            <div class="card">
                <h4 class="card-header"><b>Instructions</b></h4>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <?php
                                ...
                                echo "<tr><td>" .$row["instruction"]."</td><td><input type ='checkbox' name='checkbox[]' value='".$row["instruction"]."'></td></tr>";
                            ...
                            <a href="instru.php"  data-toggle="modal" data-target="#myModal">Ajouter une instruction</a>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Ajouter une instruction</h4>
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            
                                        </div>
                                        <div class="modal-body">
                                            <form action="instru.php" method="POST">
                                                <div class="form-group row">
                                                    <div class="form-group col-md-6">
                                                        <label class="sr-only" for="instruction">Instruction</label>
                                                        <input type="text" class="form-control form-control-sm mr-1" name="instruction" id="instruction" placeholder="Instruction" required>
                                                    </div>
